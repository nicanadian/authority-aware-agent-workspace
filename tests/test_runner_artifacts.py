...
class MinimalRunnerArtifactTests(unittest.TestCase):
    ...
    def test_runner_evaluator_report_metrics_match_side_channel_fixture(self):
        ...
        self.assertEqual(report["unsupported_candidate_state_count"], 2)
        self.assertEqual(report["unsupported_candidate_state_count"], report["counts"]["unsupported_candidate_state_objects"])
